...
class _SeriesScreenState extends State<SeriesScreen> {
  ...
  Future<void> refresh() {
    var test = Provider.of<StateManager>(context, listen: false)
  ...
  Widget build(BuildContext context) {
    Color color = Provider.of<SettingsHandler>(context).accentColor;
    Color background = Provider.of<SettingsHandler>(context).backgroundColor;
                          ...
                          FittedBox(
                            child: Text("See all",
                                style: TextStyle(
                                    color: themeMode.fontColor,
                                    fontFamily: themeMode.fontFamilyUse,
                                    fontSize: themeMode.fontFamilyUse == "stalinist" ? 10:14,
                          ...
                          child: list.popularSeries.isEmpty
                              ...
                              : Row(
                                  ...
                                  (index) => GestureDetector(
                                    child: MovieCard(
                                      poster:
                                          list.popularSeries[index].posterPath,
